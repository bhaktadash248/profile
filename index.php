...
<body id="top">
            ...
            <div class="container">
              <div class="content-center">
                ...
                <p class="category text-white">Fullstack Developer</p><a class="btn btn-primary smooth-scroll mr-2"
                  ...
                  class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
              </div>
            </div>
            <div class="section">
              <div class="container">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <p>Hello! I am Bhakta Dash. Fillstack Developer.</p>
                  <p> More then 4 years of experience in SoftwareDevelopment, which includes bothFront-end and Back-end
                  </p>
  ...
  <footer class="footer">
    <div class="container text-center">
      <a class="cc-linkedln btn btn-link" href=""><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
