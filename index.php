...
<head>
  ...
  <title>Bhakta Dash</title>
  <meta name="description" content="Bhakta Dash profile" />
  <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700,200" rel="stylesheet">
  <link href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css" rel="stylesheet">
  <link href="css/aos.css" rel="stylesheet">
  <link href="css/bootstrap.min.css" rel="stylesheet">
  <link href="styles/main.css" rel="stylesheet">
  <link rel="icon" href="./images/profile_Fav_icon.jpg" type="image/gif" sizes="16x16">
</head>

<body id="top">
  <!-- Global site tag (gtag.js) - Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-149587768-1"></script>
  <script>
    // disable right click
  ...
  <header>
    <div class="profile-page sidebar-collapse">
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
        <div class="container">
          <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Bhakta Dash</a>
          ...
          <div class="page-header page-header-small" filter-color="green">
            ...
            <div class="container">
              <div class="content-center">
                <div class="cc-profile-image"><a href="#"><img src="images/bhakta.jpg" alt="Image" /></a></div>
                <div class="h2 title">Bhakta Dash</div>
                <p class="category text-white">Fullstack Developer</p><a class="btn btn-primary smooth-scroll mr-2"
                  href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a
                  class="btn btn-primary" target="_Blank" href="./docs/bhakta_resume.pdf" data-aos="zoom-in"
              ...
              <div class="container">
                <div class="button-container">
                  <a class="btn btn-default btn-round btn-lg btn-icon" target="_Blank"
                    href="https://www.linkedin.com/in/bhakta-batchala-dash-35923b95/" rel="tooltip"
                    title="Connect with me on linkedin">
                    <i class="fa fa-linkedin"></i>
                  </a>
                  <a class="btn btn-default btn-round btn-lg btn-icon" target="_Blank"
                    href="https://github.com/bhaktadash248/" rel="tooltip" title="Visit My github">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <p>Hands-on experience in Front-end development technologies HTML5, CSS3, JavaScript, React JS, AJAX &
                    jQuery and back-end development with PHP, NodeJS, MySQL.</p>
                  <p> Experience in working with E-commerce and Blockchain Domains.</p>
                  <p>Worked with clients: Full Compass, Nets & RAK Bank</p>
                  </p>
                </div>
              </div>
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-8">dashlucky248@gmail.com</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
                    <div class="col-sm-8">+91-7795149654</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
                    <div class="col-sm-8">Sarjapur, Bangalore</div>
                  </div>
                  <div class="row mt-3">
          ...
          <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">Material Ui</span>
                    <div class="progress">
                      <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10"
                        data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0"
    ...
    <div class="tab-content gallery mt-5">
        ...
        <div class="container cc-experience">
            ...
            <div class="row">
              <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body cc-experience-header">
                  ...
                  <div class="h5">L&T Infotech</div>
                </div>
              </div>
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Software Engineer</div>
                  <p>my responsibility is requirement gathering and time estimation and develop mobile responsive
                    screens provided by UX team and need to build the react components.
                    Integration with back-end API for displaying dynamic react component.
                    To rectify/ resolve GIT merge issues, if any.
                  </p>
                  <p>Achievements: Client suggested buy option from a 3rd party vendor but as per our (we represented
                    LN& Infotech) suggestion, we developed a better featured product.
                    There was 100% acceptance from client with 0 UAT defects.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="row">
              <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body cc-experience-header">
                  <p>March 2016 - Nov 2016</p>
                  <div class="h5">Digitera Technologies</div>
                </div>
              </div>
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Junior Web Developer</div>
          ...
          <div class="card">
            <div class="row">
              <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body cc-experience-header">
                  <p>May 2015 - February 2016</p>
                  <div class="h5">Cannykart</div>
                </div>
              </div>
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
        ...
        <div class="container cc-education">
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Bachelor of Electronics and Communication engineer</div>
                  <p class="category">centurion university of technology and management</p>
                  <p></p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  ...
                  <p class="category">binayak acharya junior college</p>
                  <p></p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  <div class="h5">Science and Mathematics</div>
                  <p class="category">Queen of the mission high school</p>
                  <p></p>
                </div>
              </div>
            </div>
      ...
      <div class="section" id="reference">
        <div class="container cc-reference">
          <div class="h4 mb-4 text-center title">Recommendations</div>
            ...
            <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 cc-reference-header"><img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfARWrne-XAY8gNwa8Z2dA9ivVp6aupjP5bepsGt5C4lQP5LWneg"
                        alt="Image" />
                      <div class="h5 pt-2">Rakesh Moturi</div>
                      <p class="category">Solution Architect</p>
                    </div>
                    <div class="col-lg-9 col-md-8">
                      <p>Pleasure to work with Bhakta in a project. He is very hard working, committed and curious to
                        learn person. He always tried to come out of his comfort zone and tried to help the team.</p>
                    </div>
                  </div>
                </div>
                <div class="carousel-item">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 cc-reference-header"><img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaPkl_TLOttMNLCrH7PM6WE76-YxoTeDGu7RbHcXAxwChGjwJzbA"
                        alt="Image" />
                      <div class="h5 pt-2">Vibha Gupta</div>
                      <p class="category">QA Lead</p>
                    </div>
                    <div class="col-lg-9 col-md-8">
                      <p>I have been working with Bhakta during Stacker project where he designed the application's UI
                        part and also took care of some additional functionality development based on ReactJS. Finding
                        bugs in his part of code was a real challenge. I should also mention here that he is one person
                        who never says no to anything, he will always take his time out to assure that not just work is
                        done on time but also delivered with high quality. His thinking towards designing UI with
                        absolute user friendliness and easy navigation is super cool!</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="card-body">
                          ...
                          <p class="pb-2">Sarjapur, Bangalore, India</p>
                          <p class="mb-0"><strong>Phone</strong></p>
                          <p class="pb-2">+91-7795149654</p>
                          <p class="mb-0"><strong>Email</strong></p>
                          <p>Dashlucky248@gmail.com</p>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <footer class="footer">
    <div class="container text-center">
      <a class="cc-linkedln btn btn-link" target="_Blank"
        href="https://www.linkedin.com/in/bhakta-batchala-dash-35923b95/">
        <i class="fa fa-linkedin fa-2x" aria-hidden="true"></i>
      </a>
      <a class="cc-linkedln btn btn-link" target="_Blank" href="https://github.com/bhaktadash248">
        <i class="fa fa-github fa-2x" aria-hidden="true"></i>
      </a>

    </div>
    <div class="h4 title text-center">Bhakta Dash</div>
